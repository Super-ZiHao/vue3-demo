...
<template>
  <div class="wraps">
      ...
      <el-pagination @current-change="changeSize" style="float:right;margin-top:10px;" background layout="prev, pager, next" :page-size="5" :total="total" />
  </div>
